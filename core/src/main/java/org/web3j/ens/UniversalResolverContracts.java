 ...
 *
 * <p>The Universal Resolver is the entry point for ENSv2-ready resolution — it handles
 * registry lookup, ENSIP-10 wildcard traversal, and CCIP-Read trampoline in a single call.
 */
